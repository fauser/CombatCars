...
namespace GenericGameEngine
{
    public class Matrix
    {
        ...
        public static readonly Matrix Identity =
            new Matrix(new Vector(1, 0, 0), new Vector(0, 1, 0), new Vector(0, 0, 1), new Vector(0, 0, 1));
        ...
        public Vector GetScale()
        {
            ...
            result.Y = (new Vector(_m21, _m22, _m33)).Length();
            result.Z = (new Vector(_m31, _m22, _m33)).Length();
            return result;
        }
        ...
        public Matrix Inverse()
        {
            ...
            result._m42 = -(_m42 * result._m12 + _m42 * result._m22 + _m43 * result._m32);
            result._m43 = -(_m43 * result._m13 + _m42 * result._m23 + _m43 * result._m33);
